...
pset1 = list(dir1 = 'Data/new_aligned_shapesv3/by_species/Lepilemur/',dir2 = 'Data/new_aligned_shapesv3/by_species/Galago/',
...
pset2 =  list(dir1 = 'Data/new_aligned_shapesv3/by_species/Varecia/',dir2 = 'Data/new_aligned_shapesv3/by_species/Lepilemur/',
              num_cones = 35, cap_radius = 0.15, len = 100, directions_per_cone = 5,
              dirs = generate_equidistributed_cones(num_directions = 35, cap_radius =  0.15, directions_per_cone = 5))
pset3 = list(dir1 = 'Data/new_aligned_shapesv3/by_species/Varecia/',dir2 = 'Data/new_aligned_shapesv3/by_species/Tarsius/',
             num_cones = 35, cap_radius = 0.15, len = 100, directions_per_cone = 5,
             dirs = generate_equidistributed_cones(num_directions = 35, cap_radius =  0.15, directions_per_cone = 5))
pset4 = list(dir1 = 'Data/new_aligned_shapesv3/by_species/Alouatta/',dir2 = 'Data/new_aligned_shapesv3/by_species/Ateles/',
             num_cones = 35, cap_radius = 0.15, len = 100, directions_per_cone = 5,
             dirs = generate_equidistributed_cones(num_directions = 35, cap_radius =  0.15, directions_per_cone = 5))
pset5 = list(dir1 = 'Data/new_aligned_shapesv3/by_species/Brachyteles/',dir2 = 'Data/new_aligned_shapesv3/by_species/Ateles/',
             num_cones = 35, cap_radius = 0.15, len = 100, directions_per_cone = 5,
             dirs = generate_equidistributed_cones(num_directions = 35, cap_radius =  0.15, directions_per_cone = 5))
pset6 = list(dir1 = 'Data/new_aligned_shapesv3/by_species/Alouatta/',dir2 = 'Data/new_aligned_shapesv3/by_species/Brachyteles/',
             num_cones = 35, cap_radius = 0.15, len = 100, directions_per_cone = 5,
             dirs = generate_equidistributed_cones(num_directions = 35, cap_radius =  0.15, directions_per_cone = 5))
pset7 = list(dir1 = 'Data/new_aligned_shapesv3/by_species/Callicebus/',dir2 = 'Data/new_aligned_shapesv3/by_species/Saimiri/',
             num_cones = 35, cap_radius = 0.15, len = 100, directions_per_cone = 5,
             dirs = generate_equidistributed_cones(num_directions = 35, cap_radius =  0.15, directions_per_cone = 5))
...
save.image('chris_doug_analysis.Rdata')
