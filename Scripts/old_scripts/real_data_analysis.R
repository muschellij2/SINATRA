...
source('Final Code for Functions (Really)/sinatra/R/Reconstruction_Functions.R')
source('Final Code for Functions (Really)/SINATRA_Simulation_Balled_EC copy.R')
source('Final Code for Functions (Really)/sinatra/R/Plotting_Functions.R')
source('Final Code for Functions (Really)/sinatra/R/Feature_Selection_Functions.R')
source('SINATRA/SINATRA_Pipeline_Branch/gp_landmarking.R')
...
old_fruit_dir = 'Data/new_aligned_shapes/Old_Frugivore/'
old_veg_dir='Data/new_aligned_shapes/Old_Follivore/'
old_bug_dir='Data/new_aligned_shapes/Old_Insectivore/'
new_fruit_dir = 'Data/new_aligned_shapes/New_Frugivore/'
new_veg_dir='Data/new_aligned_shapes/New_Follivore/'
new_bug_dir='Data/new_aligned_shapes/New_Insectivore/'
...
fruit_veg_new=feature_selection_data_skinny(dir1=new_fruit_dir,dir2 = new_veg_dir,direction=dirs,class1='Fruit', class2='Vegetable',
                                            radius=0,accuracy=FALSE,len = len, ball = ball, ball_radius = ball_radius, ec_type = ec_type)

fruit_bug_new=feature_selection_data_skinny(dir1 = new_fruit_dir,dir2 = new_bug_dir,class1='Fruit', direction=dirs,len=len,
                                            class2='Bug',accuracy=FALSE,radius=0, ball = ball, ball_radius = ball_radius, ec_type = ec_type)

veg_bug_new=feature_selection_data_skinny(dir1 = new_veg_dir,dir2 = new_bug_dir,class1='Veg', direction=dirs,len=len,class2='Bug',
                                          radius=0,accuracy=FALSE, ball = ball, ball_radius = ball_radius, ec_type = ec_type)
fruit_veg_old=feature_selection_data_skinny(dir1=old_fruit_dir,dir2 = old_veg_dir,direction=dirs,class1='Fruit', class2='Vegetable',
                                            radius=0,accuracy=FALSE,len = len, ball = ball, ball_radius = ball_radius, ec_type = ec_type)

fruit_bug_old=feature_selection_data_skinny(dir1 = old_fruit_dir,dir2 = old_bug_dir,class1='Fruit', direction=dirs,len=len,
                                            class2='Bug',accuracy=FALSE,radius=0, ball = ball, ball_radius = ball_radius, ec_type = ec_type)

veg_bug_old=feature_selection_data_skinny(dir1 = old_veg_dir,dir2 = old_bug_dir,class1='Veg', direction=dirs,len=len,class2='Bug',
                                          radius=0,accuracy=FALSE, ball = ball, ball_radius = ball_radius, ec_type = ec_type)

fruit_fruit_old=feature_selection_data_skinny(dir1=new_fruit_dir,dir2 = old_fruit_dir,direction=dirs,class1='Fruit', class2='Fruit',
                                              radius=0,accuracy=FALSE,len = len, ball = ball, ball_radius = ball_radius, ec_type = ec_type)

veg_veg_old=feature_selection_data_skinny(dir1=new_veg_dir,dir2 = old_veg_dir,direction=dirs,class1='Vegetable', class2='Vegetable',
                                          radius=0,accuracy=FALSE,len = len, ball = ball, ball_radius = ball_radius, ec_type = ec_type)
bug_bug_old=feature_selection_data_skinny(dir1=new_bug_dir,dir2 = old_bug_dir,direction=dirs,class1='Bug', class2='Bug',
                                          radius=0,accuracy=FALSE,len = len, ball = ball, ball_radius = ball_radius, ec_type = ec_type)
