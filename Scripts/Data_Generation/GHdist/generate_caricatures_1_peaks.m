...
out_mesh_path = ['/Users/brucewang/Dropbox (Princeton)/Data + Experiments Tim Sudijono/Data/new_aligned_shapesv3/' meshName '_2peak_2gpv2bw/'];
...
for k = 1:50
    ...
    meshNames = getFileNames(raw_mesh_path);
    %testIdxes = {[2],[5]};
    idxs1 = randsample(1:6,1, false)
    idxs2 = randsample(setdiff(1:6,idxs1),1,false)
    testIdxes = {idxs1,idxs2}
    for jj=1:25
        for jjj=1:2
            G = load(['/Users/brucewang/Dropbox (Princeton)/Data + Experiments Tim Sudijono/Data/GHdist/samples/' meshName '.mat']);
            G = G.G;
