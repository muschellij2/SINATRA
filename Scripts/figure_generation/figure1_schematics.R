...
rgl.viewpoint(userMatrix = rotation_matrix)
rgl.snapshot(filename = '~/Dropbox (DataPlusMath)/Sub-Image Analysis/Manuscript/Figures/Figure Drafts/figure1/figure1a_v3.png',fmt = 'png')
rgl.postscript(filename = '~/Dropbox (DataPlusMath)/Sub-Image Analysis/Manuscript/Figures/figures/figure1/figure1a_v2.pdf',fmt = 'pdf')
#1b
arrow_type = 'rotation'
s = 1/10
width = 1/9
...
#plot_selected_landmarks(fruit1,fruit1_vert)
rgl.viewpoint(userMatrix = rotation_matrix)
rgl.snapshot(filename = '~/Dropbox (DataPlusMath)/Sub-Image Analysis/Manuscript/Figures/Figure Drafts/figure1/figure1b_v4.png',fmt = 'png')
...
rgl.snapshot(filename = '~/Dropbox (DataPlusMath)/Sub-Image Analysis/Manuscript/Figures/Figure Drafts/figure1/figure1c_v3.png',fmt = 'png')
