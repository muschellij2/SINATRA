...
mesh2_heat =  reconstruct_vertices_on_shape(dir = pset2$dirs,complex = mesh_2,rate_vals = comp2$Rate2,
                                               len = pset2$len,cuts = 500,cone_size = pset2$directions_per_cone,ball_radius = ball_radius, ball = ball,radius =1)
mesh4_2_heat =  reconstruct_vertices_on_shape(dir = pset4$dirs,complex = mesh_2,rate_vals = comp4$Rate2,
                                               len = pset4$len,cuts = 500,cone_size = pset4$directions_per_cone,ball_radius = ball_radius, ball = ball,radius =1)
mesh5_2_heat =  reconstruct_vertices_on_shape(dir = pset5$dirs,complex = mesh_2,rate_vals = comp5$Rate2,
                                               len = pset5$len,cuts = 500,cone_size = pset5$directions_per_cone,ball_radius = ball_radius, ball = ball,radius =1)
...
#points3d( mesh2$vb[,4845][-4][1],mesh2$vb[,4845][-4][2],mesh2$vb[,4845][-4][3], size = 8, col = 'black')
