...
#### 3 v 3 ####
base_dir = '~/gitrepos/new_aligned_shapesv3/'
...
ROC_curve_plt <- ggplot(data <- roc_curve1_frame,aes(x = X1, y = X2, group = X3)) +
  geom_line(stat = "identity",aes(color = factor(X3) ), size = 0.6) +
...
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_1_roc_dirs.pdf')
...
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_2_roc_dirs.pdf')
#ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_2_roc_dirs.pdf')
...
og_mesh = vcgImport(file = '~/gitrepos/clean_V13_sas.off')
...
ROC_curve_plt <- ggplot(data <- roc_curve_len_1_frame,aes(x = X1, y = X2, group = X3)) +
  ...
  guides(color = guide_legend(override.aes = list(size = 1.5)))
print(ROC_curve_plt)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_1_roc_lengths.pdf')
ROC_curve_plt2 <- ggplot(data <- roc_curve_len_2_frame,aes(x = X1, y = X2, group = X3)) +
  ...
  guides(color = guide_legend(override.aes = list(size = 1.5)))
print(ROC_curve_plt2)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_2_roc_lengths.pdf')
# Varying Angle Up
...
print(ROC_curve_plt)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_1_roc_angles.pdf')
...
#  scale_colour_hue(l=0)
print(ROC_curve_plt2)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_2_roc_angles.pdf')
...
print(ROC_curve_plt)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_1_roc_dir_per_cone.pdf')
ROC_curve_plt2 <- ggplot(data <- roc_curve2_frame,aes(x = X1, y = X2, group = X3)) +
  geom_line(stat = "identity",aes(color = factor(X3) ), size = 0.6) +
  labs(x = "False Positive Rate (FPR)", y = "True Positive Rate (TPR)", color = "# Directions") +
  ggtitle(sprintf("ROC Curve for Class 2 Teeth - 3 Peaks")) +
...
print(ROC_curve_plt2)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_3_peaks_Class_2_roc_dir_per_cone.pdf')
...
print(ROC_curve_plt)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_1_roc_dirs.pdf')
ROC_curve_plt2 <- ggplot(data <- roc_curve2_frame,aes(x = X1, y = X2, group = X3), size = 1.5) +
  geom_line(stat = "identity",aes(color = factor(X3) ),size = 0.6) +
  labs(x = "False Positive Rate (FPR)", y = "True Positive Rate (TPR)", color = "# Cones") +
...
print(ROC_curve_plt2)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_2_roc_dirs.pdf')

# Varying Length Up

base_dir = '~/gitrepos/new_aligned_shapesv4/'
data_dirs = list.dirs(base_dir,recursive = FALSE)
...
ROC_curve_plt <- ggplot(data <- roc_curve_len_1_frame,aes(x = X1, y = X2, group = X3)) +
  ...
  guides(color = guide_legend(override.aes = list(size = 1.5))) 
print(ROC_curve_plt)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_1_roc_lengths.pdf')
ROC_curve_plt2 <- ggplot(data <- roc_curve_len_2_frame,aes(x = X1, y = X2, group = X3)) +
  geom_line(stat = "identity",aes(color = factor(X3) ), size = 0.6) +
  labs(x = "False Positive Rate (FPR)", y = "True Positive Rate (TPR)", color = "Lengths") +
  ...
  guides(color = guide_legend(override.aes = list(size = 1.5))) 
print(ROC_curve_plt2)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_2_roc_lengths.pdf')
...
print(ROC_curve_plt)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_1_roc_angles.pdf')
ROC_curve_plt2 <- ggplot(data <- roc_curve2_frame,aes(x = X1, y = X2, group = X3), size = 1.5) +
  geom_line(stat = "identity",aes(color = factor(X3) ),size = 0.6) +
  labs(x = "False Positive Rate (FPR)", y = "True Positive Rate (TPR)", color = "Cone Angle") +
  ggtitle(sprintf("ROC Curve for Class 2 Teeth - 5 Peaks")) +
...
print(ROC_curve_plt2)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_2_roc_angles.pdf')
...
print(ROC_curve_plt)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_1_roc_dir_per_cone.pdf')
ROC_curve_plt2 <- ggplot(data <- roc_curve2_frame,aes(x = X1, y = X2, group = X3)) +
  geom_line(stat = "identity",aes(color = factor(X3) ), size = 0.6) +
  labs(x = "False Positive Rate (FPR)", y = "True Positive Rate (TPR)", color = "# Directions") +
  ggtitle(sprintf("ROC Curve for Class 2 Teeth - 5 Peaks")) +
...
print(ROC_curve_plt2)
ggsave('~/gitrepos/SINATRA/Scripts/Data/CaricaturedTeeth_5_peaks_Class_2_roc_dir_per_cone.pdf')
...
#### 1 v 1 ####
base_dir = '~/gitrepos/new_aligned_shapesv5/'
data_dirs = list.dirs(base_dir,recursive = FALSE)
...
roc_curve1 = read.csv('~/gitrepos/new_aligned_shapesv4/V13_5peak_2gp_v1_bw/roc_dirs1.csv')
roc_curve2 = read.csv('~/gitrepos/new_aligned_shapesv4/V13_5peak_2gp_v1_bw/roc_dirs2.csv')
...
roc_curve_len_1 = read.csv('~/gitrepos/new_aligned_shapesv4/V13_5peak_2gp_v1_bw/roc_lens1.csv')
roc_curve_len_2 = read.csv('~/gitrepos/new_aligned_shapesv4/V13_5peak_2gp_v1_bw/roc_lens2.csv')
